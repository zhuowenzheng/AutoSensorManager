...
public:
    Sensor() {
        // 初始化传感器参数数组指针
        sensor_parameter = new T[1];
        // 初始化传感器参数数组大小
        sensor_parameter_size = 1;
        // 初始化传感器参数数组实际大小
        sensor_parameter_actual_size = 0;
    }
    ~Sensor() {
        // 删除传感器参数数组指针
    ...
    // 设置传感器参数数组指针
    void setSensorParameter(T* _sensor_parameter) {
        this->sensor_parameter = sensor_parameter;
    }
    // 获取传感器参数数组指针
    T* getSensorParameter() {
    ...
    // 设置传感器参数数组实际大小
    void setSensorParameterActualSize(int _sensor_parameter_actual_size) {
        this->sensor_parameter_actual_size = sensor_parameter_actual_size;
    }
    // 获取传感器参数数组实际大小
    ...
    void setSensorParameterFlag(int _sensor_parameter_flag) {
        this->sensor_parameter_flag = sensor_parameter_flag;
    }
    // 获取传感器参数数组标志
